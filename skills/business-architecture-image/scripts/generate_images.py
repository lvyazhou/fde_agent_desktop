...
# ============ 配置 ============
# API 地址与 Key 均可用环境变量覆盖，未设置时回退内置默认值（开箱即用）。
API_BASE_URL = os.environ.get("IMAGE_API_BASE_URL", "https://api.360.cn/v1")
API_KEY = os.environ.get("IMAGE_API_KEY", "fk408236517.q-NV5lGE2luezM_4l7fevr-rV_WmmVxv96716562")
...
def generate_images(args):
    ...
    # 带自动重试的请求：应对网关偶发的 5xx / 超时 / “服务异常(10181)”等抖动
