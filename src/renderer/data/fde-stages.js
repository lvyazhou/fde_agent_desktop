...
export const FDE_STAGES = [
  {
    ...
    steps: '资料收集 / 需求梳理', // 步骤卡副标题:这一阶段实际在做的两件事
  ...
  },
  {
    ...
    deliverables: [
      ...
      { key: 'impl-plan', name: '产品实施计划表', form: 'md', note: '前期调研/SDR部署/里程碑,带责任人·工期·前置依赖' },
      { key: 'data-metric', name: '业务数据口径模板', form: 'md', note: '每个指标取数SQL+数据来源表,数据集优先复用SDR标准库;阶段④建模阶段⑤验收对账' },
...
export const DELIVERABLE_META = {
  ...
  'prd2':           { name: '产品需求文档 PRD（三层）', short: 'PRD',     icon: 'fa-solid fa-file-lines' },
  'feature-spec':   { name: '产品功能清单（六字段）', short: '功能清单', icon: 'fa-solid fa-list-check' },
  // 阶段③
  ...
  'task-plan':      { name: '产品实施计划表',        short: '实施计划',   icon: 'fa-solid fa-calendar-check' },
  'impl-plan':      { name: '产品实施计划表',        short: '实施计划',   icon: 'fa-solid fa-calendar-check' },
  'data-metric':    { name: '业务数据口径模板',      short: '数据口径',   icon: 'fa-solid fa-ruler-combined' },
  // 阶段④
