...
function fileIcon(name) {
  ...
  const map = {
    ...
    jsx: 'fa-solid fa-file-code text-cyan-500',
    ...
    scss: 'fa-brands fa-sass text-pink-500',
    ...
    go: 'fa-solid fa-file-code text-cyan-600',
    rs: 'fa-solid fa-file-code text-orange-600',
    png: 'fa-solid fa-file-image text-purple-400',
    jpg: 'fa-solid fa-file-image text-purple-400',
    svg: 'fa-solid fa-file-image text-purple-400',
  };
